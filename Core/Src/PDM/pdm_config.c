...
_PDM_table PDM__Table(uint8_t number_pwr_channel){
	...
	switch(number_pwr_channel){
		...
		case PDM_PWR_Channel_1:
			...
			pdm_table.I2Cx_I2C_MUX = PDM_I2Cx_I2C_MUX1;
			...
			pdm_table.pin_EN_eFuse = TCA9539_IO_P00;			//EN_eFusee_in_ch1 (U19)
			pdm_table.pin_PG_eFuse = TCA9539_IO_P01;			//PG_eFusee_in_ch1 (U19)
		...
		case PDM_PWR_Channel_3:
			...
			pdm_table.I2Cx_GPIO_Ext = PDM_I2Cx_GPIOExt1;
			pdm_table.I2C_addr_GPIO_Ext = PDM_I2CADDR_GPIOExt1;
			pdm_table.pin_EN_eFuse = TCA9539_IO_P05;			//EN_eFusee_in_ch3 (U19)
			pdm_table.pin_PG_eFuse = TCA9539_IO_P06;			//PG_eFusee_in_ch3 (U19)
		...
		case PDM_PWR_Channel_4:
			...
			pdm_table.I2Cx_GPIO_Ext = PDM_I2Cx_GPIOExt2;
			pdm_table.I2C_addr_GPIO_Ext = PDM_I2CADDR_GPIOExt2;
			pdm_table.pin_EN_eFuse = TCA9539_IO_P05;			//EN_eFusee_in_ch4 (U20)
			pdm_table.pin_PG_eFuse = TCA9539_IO_P06;			//PG_eFusee_in_ch4 (U20)
		...
		case PDM_PWR_Channel_5:
			...
			pdm_table.I2Cx_GPIO_Ext = PDM_I2Cx_GPIOExt1;
			pdm_table.I2C_addr_GPIO_Ext = PDM_I2CADDR_GPIOExt1;
			pdm_table.pin_EN_eFuse = TCA9539_IO_P12;			//EN_eFusee_in_ch5 (U19)
			pdm_table.pin_PG_eFuse = TCA9539_IO_P13;			//PG_eFusee_in_ch5 (U19)
		...
		case PDM_PWR_Channel_6:
			...
			pdm_table.I2Cx_GPIO_Ext = PDM_I2Cx_GPIOExt2;
			pdm_table.I2C_addr_GPIO_Ext = PDM_I2CADDR_GPIOExt2;
			pdm_table.pin_EN_eFuse = TCA9539_IO_P12;			//EN_eFusee_in_ch6 (U20)
			pdm_table.pin_PG_eFuse = TCA9539_IO_P13;			//PG_eFusee_in_ch6 (U20)
