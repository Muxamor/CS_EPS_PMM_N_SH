...
_PDM_table PDM__Table(uint8_t number_pwr_channel){
	...
	switch(number_pwr_channel){
		...
		case PDM_PWR_Channel_2:
			...
			pdm_table.I2Cx_I2C_MUX = PDM_I2Cx_I2C_MUX2;
		...
		case PDM_PWR_Channel_7:
			...
			pdm_table.I2Cx_PWR_Mon = PDM_I2Cx_PWR_Mon_Ch7;
		...
		case PDM_PWR_Channel_8:
			...
			//Config Power monitor INA238 for power channel 2
			pdm_table.I2Cx_PWR_Mon = PDM_I2Cx_PWR_Mon_Ch8;
		...
		case PDM_PWR_Channel_9:
			...
			pdm_table.I2Cx_PWR_Mon = PDM_I2Cx_PWR_Mon_Ch9;
		...
		case PDM_PWR_Channel_10:
			...
			pdm_table.I2Cx_PWR_Mon = PDM_I2Cx_PWR_Mon_Ch10;
		...
		case PDM_PWR_Channel_11:
			...
			pdm_table.I2Cx_PWR_Mon = PDM_I2Cx_PWR_Mon_Ch11;
		...
		case PDM_PWR_Channel_12:
			...
			pdm_table.I2Cx_PWR_Mon = PDM_I2Cx_PWR_Mon_Ch12;
