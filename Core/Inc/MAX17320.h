...
#define MAX17320_LSB_mA			0.0015625	// LSB for current 0.0015625mV/RSENSE per bit
#define MAX17320_LSB_mAh		0.005		// LSB for capacity 0.005mAh/RSENSE per bit
...
typedef struct // The Battery Branch Data
{
	...
	uint8_t MaxVCELL_mV; 	// MaxVCELL value. Maximum channel voltage reading (20mV resolution).
	uint8_t MinVCELL_mV; 	// MinVCELL value. Minimum VCell register reading (20mV resolution).
	...
	int8_t MaxCurr_mA; 		// MaxCurr value. Maximum Current register reading (0.40mV resolution).
	int8_t MinCurr_mA; 		// MinCurr value. Minimum Current register reading (0.40mV resolution).
	...
	uint16_t RepSOC_mAh; 		// RepSOC Register. RepSOC is a filtered version of the AvSOC register that prevents large jumps.
