...
typedef struct{
    ...
    uint8_t Deploy_stage;           //  0-In delivery containerr, 1-one Limit switch and whait generation, 2-low level energy (if low waiting generation), 3-waiting timeout before deploy, 4- deployed Z+  5- deployed Z-
