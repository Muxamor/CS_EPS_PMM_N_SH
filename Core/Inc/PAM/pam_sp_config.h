...
#define PAM_SP_quantity  			    0x04 // Quantity solar panel on the satellite
#define PAM_SP_temp_sens_max_quantity   0x04 // Max quantity Temp. sensor per solar panel.
#define PAM_SP_ID_max_quantity	        0x03 // Max quantity Ideal Diode per solar panel.

#define PAM_SP1           			    0x00 //Solar panel namber 1 is Y+ Mule
#define PAM_SP2          			    0x01 //Solar panel namber 2 is X- Mule
#define PAM_SP3         			    0x02 //Solar panel namber 3 is Y- Mule
#define PAM_SP4         			    0x03 //Solar panel namber 4 is X+ Mule
...
#define PAM_SP1_temp_sens_quantity      0x04  // Quantity temp senos on the solar panel namber 1 is Y+ Mule
#define PAM_SP2_temp_sens_quantity      0x04  // Quantity temp senos on the solar panel namber 2 is X- Mule
#define PAM_SP3_temp_sens_quantity      0x04  // Quantity temp senos on the solar panel namber 3 is Y- Mule
#define PAM_SP4_temp_sens_quantity      0x04  // Quantity temp senos on the solar panel namber 4 is X+ Mule
...
#define PAM_SP3_ID_quantity             0x02  // Quantity Ideal Diode on the solar panel namber 3 is Y- Mule
#define PAM_SP4_ID_quantity             0x03  // Quantity Ideal Diode on the solar panel namber 4 is X+ Mule
...
//I2C address temp senos on the solar panel namber 1 Y+
...
#define PAM_SP1_I2CADDR_GPIO_Ext_1      0x38

//I2C address temp senos on the solar panel namber 2 is X-
...
//I2C address temp senos on the solar panel namber 3 is Folding Y-
...
#define PAM_SP3_I2CADDR_GPIO_Ext_1      0x38

//I2C address temp senos on the solar panel namber 4 is X+
