...
typedef struct  // Structure for PBM data
{
	...
	uint8_t Error_DS2777_1 :1; 				// Register error DS2777 �1.
	uint8_t Error_DS2777_2 :1; 				// Register error DS2777 �2.
	uint8_t Error_TMP1075_1 :1; 			// Register error TMP1075 �1.
	uint8_t Error_TMP1075_2 :1; 			// Register error TMP1075 �1.
	uint8_t Error_TMP1075_3 :1; 			// Register error TMP1075 �1.
	uint8_t Error_TMP1075_4 :1; 			// Register error TMP1075 �1.
	uint8_t Error_PCA9534 :1; 				// Register error PCA9534.
	uint8_t Error_Heat_1 :1; 				// Register error heat branch �1.
	uint8_t Error_Heat_2 :1; 				// Register error heat branch �2.
	uint8_t Error_Charge_1 :1; 				// Register error charge branch �1.
	uint8_t Error_Charge_2 :1; 				// Register error charge branch �2.
