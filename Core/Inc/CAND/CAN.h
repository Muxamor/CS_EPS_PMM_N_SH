...
>>>>>>> upstream/master
    ...
    uint8_t CAN_Line1;                      //+12           Командный регистр линии 1 (СОП1)
    uint8_t CAN_Line2;                      //+13           Командный регистр линии 2 (СОП2)
    uint8_t CAN_Line3;                      //+14           Командный регистр линии 3 (БРК1)
    uint8_t CAN_Line4;                      //+15           Командный регистр линии 4 (БРК2)
    uint8_t CAN_Line5;                      //+16           Командный регистр линии 5 ( - )
    uint8_t CAN_Line6;                      //+17           Командный регистр линии 6 ( - )
    uint8_t CAN_Line_VBAT1;                 //+18           Командный регистр линии VBAT1 (МС)
